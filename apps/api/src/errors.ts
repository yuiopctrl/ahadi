...
const errorStatus: Record<ApiErrorCode, number> = {
  ...
  PIN_INVALID: 400,
  PIN_LOCKED: 423,
  AUTH_CONFIGURATION_REQUIRED: 503,
  ...
  USER_ALREADY_IN_TENANT: 409,
  USER_NOT_FOUND: 404,
  ROLE_NOT_FOUND: 400,
  LAST_OWNER_REQUIRED: 409,
  OWNER_ROLE_REQUIRES_OWNER: 403,
  ...
  PLEDGE_REQUIRED_FOR_PAYMENT: 409,
  ...
  CUSTOM_SMS_BATCH_TOO_LARGE: 400,
  CUSTOM_SMS_BATCH_EMPTY: 400,
  ...
  INVALID_PLATFORM_ROLE: 400,
  PLATFORM_USER_NOT_FOUND: 404,
  CANNOT_REMOVE_LAST_PLATFORM_OWNER: 409,
  INVALID_PLATFORM_USER_STATUS: 400,
  ...
  INVITATION_TOKEN_INVALID: 401,
  INVITATION_TOKEN_EXPIRED_OR_ROTATED: 401,
  INVITATION_TEMPLATE_NOT_FOUND: 404,
  RSVP_DISABLED: 409,
  RSVP_DEADLINE_PASSED: 409,
  RSVP_GUEST_COUNT_INVALID: 400,
